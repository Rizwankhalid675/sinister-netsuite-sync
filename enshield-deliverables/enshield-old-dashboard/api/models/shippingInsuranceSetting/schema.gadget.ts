...
export const schema: GadgetModel = {
  ...
  fields: {
    baseAmount: {
      ...
      storageKey: "enshield-pricing-base-amount",
    },
    basePercentage: {
      type: "string",
      validations: { required: true },
      storageKey: "enshield-pricing-base-percentage",
    },
    currency: {
      type: "string",
      validations: { required: true },
      storageKey: "enshield-pricing-currency",
    },
    effectiveAt: {
      type: "dateTime",
      validations: { required: true },
      storageKey: "enshield-pricing-effective-at",
    },
    pricingVersion: {
      type: "string",
      validations: { required: true },
      storageKey: "enshield-pricing-version",
    },
    shopVersionKey: {
      type: "string",
      validations: { required: true, unique: true },
      storageKey: "enshield-pricing-shop-version-key",
    },
    apiEndpoint: {
      type: "string",
      validations: { required: true },
